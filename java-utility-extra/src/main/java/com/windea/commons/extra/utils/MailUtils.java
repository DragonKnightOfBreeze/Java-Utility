...
import com.windea.commons.base.utils.ArrayUtils;
import com.windea.commons.base.utils.PathUtils;
...
public class MailUtils {
	...
	public static void send(@NotNull String host, @NotNull String fromEmail, @NotNull String toEmail,
		...
		Session session;
		if(!ArrayUtils.isLessE(authInfo, 2)) {
			//设置为需要进行身份验证
		...
		try {
			...
			// 设置附件内容
			if(!ArrayUtils.isEmpty(attachInfo)) {
