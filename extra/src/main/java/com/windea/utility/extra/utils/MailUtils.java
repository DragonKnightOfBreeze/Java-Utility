...
package com.windea.utility.extra.utils;

import com.windea.utility.base.ext.ArrayExt;
import com.windea.utility.base.utils.PathUtils;
...
public class MailUtils {
	...
	public static void sendHTML(@NotNull String fromEmail, @NotNull String toEmail, @NotNull String subject,
			@NotNull @Language("HTML") String content, @Nullable String[] authInfo, @Nullable String[] attachInfo) {
	...
	public static void sendHTML(@NotNull String host, @NotNull String fromEmail, @NotNull String toEmail,
			@NotNull String subject, @NotNull @Language("HTML") String content, @Nullable String[] authInfo,
			@Nullable String[] attachInfo) {
	...
	public static void send(@NotNull String host, @NotNull String fromEmail, @NotNull String toEmail,
		...
		Session session;
		if(!ArrayExt.isLessE(authInfo, 2)) {
			//设置为需要进行身份验证
		...
		try {
			...
			if(contentType == ContentType.text) {
				...
				message.setContent(content, "text/" + contentType);
			}
			multipart.addBodyPart(bodyPart1);

			// 设置附件内容
			if(!ArrayExt.isEmpty(attachInfo)) {
				BodyPart bodyPart2 = new MimeBodyPart();
				String fileName = PathUtils.join(attachInfo);
